...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function fixed(){computedWidth>=1230&&document.body.scrollTop>=computedHeight?secondaryNav.classList.add("fixed"):secondaryNav.classList.remove("fixed")}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),header=document.querySelector(".willow-page-header"),open=document.querySelector(".willow-page-header__content-open"),close=document.querySelector(".willow-page-header__content-close");open.addEventListener("click",function(e){header.setAttribute("data-content-open","true")}),close.addEventListener("click",function(e){header.setAttribute("data-content-open","false")});var secondaryNav=document.querySelector(".willow-secondary-nav"),pageHeader=document.querySelector(".willow-page-header"),willowBanner=document.querySelector(".willow-banner"),computedHeight=pageHeader.offsetHeight+willowBanner.offsetHeight,computedWidth=Math.max(document.documentElement.clientWidth,window.innerWidth);window.onresize=function(){computedWidth=Math.max(document.documentElement.clientWidth,window.innerWidth),computedHeight=pageHeader.offsetHeight+willowBanner.offsetHeight,fixed()},(0,_jquery2["default"])(function(){function e(){return _jquery2["default"].map(r,function(e){return(0,_jquery2["default"])(e).offset().top})}function t(){o&&(n(),fixed(),o=!1),requestAnimationFrame(t)}function n(){var t=e(),n=(0,_jquery2["default"])("body").scrollTop(),o=t.reduce(function(e,t,o){return n>=t?o:e},-1);o!==i&&(a.removeClass("active"),a.eq(o).addClass("active"))}var o=!0,r=(0,_jquery2["default"])(".category__heading"),a=(0,_jquery2["default"])(".willow-secondary-nav__item a"),i=-1;requestAnimationFrame(t),(0,_jquery2["default"])(window).on("scroll",function(){o=!0}),a.on("click",function(e){e.preventDefault();var t=e.target.href.match(/.*#(.*)/)[1],n=(0,_jquery2["default"])("#"+t);(0,_jquery2["default"])("body").animate({scrollTop:n.offset().top},function(){window.location.hash=t})})});
},{"jquery":1}]},{},[2])
