...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery);window.$=window.jQuery=_jquery2["default"],require("./Stickyfill"),(0,_jquery2["default"])(".willow-secondary-nav").Stickyfill();var header=document.querySelector(".willow-page-header"),open=document.querySelector(".willow-page-header__content-open"),close=document.querySelector(".willow-page-header__content-close");open.addEventListener("click",function(e){header.setAttribute("data-content-open","true")}),close.addEventListener("click",function(e){header.setAttribute("data-content-open","false")});var secondaryNav=document.querySelector(".willow-secondary-nav"),pageHeader=document.querySelector(".willow-page-header"),willowBanner=document.querySelector(".willow-banner"),computedHeight=pageHeader.offsetHeight+willowBanner.offsetHeight,computedWidth=Math.max(document.documentElement.clientWidth,window.innerWidth);(0,_jquery2["default"])(function(){function e(){return _jquery2["default"].map(o,function(e){return(0,_jquery2["default"])(e).offset().top})}function t(){r&&(n(),r=!1),requestAnimationFrame(t)}function n(){var t=e(),n=(0,_jquery2["default"])(window).scrollTop(),r=t.reduce(function(e,t,r){return n>=t?r:e},-1);r!==u&&(a.removeClass("active"),a.eq(r).addClass("active"))}var r=!0,o=(0,_jquery2["default"])(".category__heading"),a=(0,_jquery2["default"])(".willow-secondary-nav__item a"),u=-1;requestAnimationFrame(t),(0,_jquery2["default"])(window).on("scroll",function(){r=!0}),a.on("click",function(e){e.preventDefault();var t=e.target.href.match(/.*#(.*)/)[1],n=(0,_jquery2["default"])("#"+t);(0,_jquery2["default"])("body, html").animate({scrollTop:n.offset().top},function(){window.location.hash=t})})});
},{"./Stickyfill":2,"jquery":1}]},{},[3])
